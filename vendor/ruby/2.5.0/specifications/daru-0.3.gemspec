...
Gem::Specification.new do |s|
  ...
  s.homepage = "http://github.com/SciRuby/daru".freeze
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<packable>.freeze, ["~> 1.3.13"])
    ...
    s.add_dependency(%q<packable>.freeze, ["~> 1.3.13"])
